<form  class="input-form user-add" method="POST" id="owneruseredit" action="{{ route('admin.admin_user_update', $user->id) }}" enctype="multipart/form-data">
@csrf
        ...
        <div class="row">
            <div class="col-xl-12 col-md-12 mb-4">          
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-9">
                      <input id="hotel_name" type="text" class="form-control @error('hotel_name') is-invalid @enderror" name="hotel_name" value="{{ $user->hotel_name }}" required autocomplete="hotel_name" autofocus>
                      @error('hotel_name')
                      <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
